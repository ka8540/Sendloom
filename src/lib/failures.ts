...
const FAILURE_SEVERITY_BY_CODE: Record<FailureCode, FailureSeverity> = {
  ...
  GMAIL_DAILY_SAFETY_LIMIT: "WARNING",
  ...
  UNRESOLVED_TEMPLATE_VARIABLE: "WARNING",
...
const HUMAN_READABLE_FAILURE_MESSAGES: Record<FailureCode, string> = {
  ...
  GMAIL_RATE_LIMITED: "Gmail is rate limiting sends right now. Sendloom will retry automatically.",
  GMAIL_SEND_REJECTED: "Gmail rejected this recipient.",
  GMAIL_TEMPORARY_FAILURE: "Gmail is temporarily unavailable for this send. Sendloom will retry automatically.",
  GMAIL_PROFILE_DISCONNECTED: "Reconnect Gmail to continue sending.",
  GMAIL_DAILY_SAFETY_LIMIT: "Sendloom paused sending to stay under Gmail's daily safety limit.",
  ...
  HARD_BOUNCE_RECIPIENT: "The address returned a permanent delivery failure and is excluded from future sends.",
