...
describe("templates library and creation wizard", () => {
  ...
  it("uses the sanitized preview renderer and returns saved templates to the library", () => {
    ...
    expect(FORM).toContain("template-review-summary");
    expect(FORM).toContain("Template summary");
    expect(FORM).toContain("previewWordCount");
    expect(FORM).toContain("previewReadingMinutes");
    expect(FORM).toContain("Variables used");
    expect(FORM).toContain("template-email-review");
    expect(FORM).toContain("Preview email");
    expect(FORM).toContain('role="document"');
    expect(FORM).toContain('aria-label="Email body preview"');
  ...
  it("provides responsive wizard, progress, and library styles", () => {
    ...
    expect(STYLES).toContain(".template-review-summary");
    expect(STYLES).toContain(".template-email-review");
    expect(STYLES).toContain("max-height: 26rem");
    expect(STYLES).toContain("overflow: auto");
    expect(STYLES).not.toContain("min-height: 320px");
