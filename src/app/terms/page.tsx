...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      ctaBody="These terms set the boundaries for how Sendloom can be used, what stays your responsibility, and when access can be removed."
      ctaTitle="Read the rules before the sequence starts moving."
      ...
      footerCopy="Built for teams who want the sending workflow, account responsibilities, and platform boundaries spelled out in the same calm voice as the product."
      ...
      visualBody="A cleaner view of the same agreement: use the product lawfully, secure your account, stay responsible for connected senders, and expect the service to protect itself when risk shows up."
      visualPoints={quickFacts.slice(0, 3)}
      visualTitle="The product rules should be easy to read before you commit."
    />
  );
}
